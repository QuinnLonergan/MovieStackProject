...
function Header({user, setUser, setLight, light}) {
  ...
  function randomStack(){
    let randomStackIds = []
    cards.map(card => randomStackIds.push(card.id))
    setRandomId(randomStackIds[Math.floor(Math.random() * randomStackIds.length)])
  }
    ...
    >
      ...
      subheader={
        <ListSubheader component="div" id="nested-list-subheader">
          ...
          <ListItemButton component={Link} to={`/stacks/${randomId}`} key={'Random Stack'}>
            <ListItemIcon >
              <HelpIcon />
            </ListItemIcon>
